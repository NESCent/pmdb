...
public class MmExperimentStudy implements java.io.Serializable,
    ...
    /** full constructor */
    public MmExperimentStudy(Integer experimentStudyOid,
	    MmReferencePart mmReferencePart,
	    MmPopulationSample mmPopulationSample, MmCvTerm mmCvTerm,
	    String name, Set mmExperimentValues,
	    Set mmExperimentStudyAttrCvtermAssocs, Set mmDataRecords) {
	this.experimentStudyOid = experimentStudyOid;
    ...
    public void setMmExperimentStudyAttrCvtermAssocs(
	    Set mmExperimentStudyAttrCvtermAssocs) {
	this.mmExperimentStudyAttrCvtermAssocs = mmExperimentStudyAttrCvtermAssocs;
    }
    ...
    public int compareTo(MmExperimentStudy o) {
