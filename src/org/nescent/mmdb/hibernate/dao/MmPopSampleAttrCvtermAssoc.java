...
public class MmPopSampleAttrCvtermAssoc implements java.io.Serializable,
	Comparable<MmPopSampleAttrCvtermAssoc> {
    ...
    /** full constructor */
    public MmPopSampleAttrCvtermAssoc(Integer mpsacaOid, MmCvTerm mmCvTerm,
	    MmPopulationSample mmPopulationSample, String value) {
	this.mpsacaOid = mpsacaOid;
    ...
    public int compareTo(MmPopSampleAttrCvtermAssoc assoc) {
	MmCvTerm term = assoc.getMmCvTerm();
	int r = this.getMmCvTerm().getName().compareTo(term.getName());
	if (r == 0) {
	    return this.getMpsacaOid().compareTo(assoc.getMpsacaOid());
	}
	return r;
    }
